...
const RouteChips = () => {
  ...
  return (
    <div className="absolute top-[150px] left-4 z-[1000] flex flex-col gap-2 pointer-events-auto max-h-[calc(100vh-220px)] overflow-y-auto scrollbar-hide max-w-[200px]">
